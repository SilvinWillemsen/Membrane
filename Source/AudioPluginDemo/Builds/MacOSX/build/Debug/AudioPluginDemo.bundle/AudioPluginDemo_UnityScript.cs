...
public class AudioPluginDemoGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "AudioPluginDemo"; } }
    public override string Description    { get { return "AudioPluginDemo"; } }
    public override string Vendor         { get { return "JUCE"; } }

    //==============================================================================
	[DllImport("AudioPluginDemo")] static extern System.IntPtr getRenderCallback();

    [DllImport("AudioPluginDemo")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("AudioPluginDemo")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("AudioPluginDemo")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("AudioPluginDemo")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("AudioPluginDemo")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("AudioPluginDemo")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
