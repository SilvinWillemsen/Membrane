...
public class audioplugin_MembraneGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_Membrane"; } }
    public override string Description    { get { return "Membrane"; } }
    public override string Vendor         { get { return "yourcompany"; } }

    //==============================================================================
	[DllImport("audioplugin_Membrane")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_Membrane")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_Membrane")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_Membrane")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_Membrane")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_Membrane")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_Membrane")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
